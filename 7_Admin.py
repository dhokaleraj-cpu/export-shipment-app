...
def _admin_clear_cache_after_write():
    """Local Admin cache clear helper.

    This prevents NameError even if common.py cache helper is not imported in Streamlit Cloud.
    """
    try:
        _admin_clear_cache_after_write()
        return
    except NameError:
        pass
    except Exception:
