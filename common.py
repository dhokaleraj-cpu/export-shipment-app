...
/* SYSTEM DEFAULT LIGHT/DARK MODE THEME - AUTO FOLLOWS DEVICE */
:root {
    --fsi-bg: #f5f7fb;
    --fsi-card: #ffffff;
    --fsi-card-2: #f8fafc;
    ...
    --fsi-muted: #475569;
    --fsi-primary: #003B73;
    --fsi-primary-soft: #1B6DB5;
    --fsi-border: #cbd5e1;
    --fsi-input-bg: #ffffff;
    --fsi-input-text: #0f172a;
    --fsi-shadow: rgba(15, 23, 42, 0.08);
    --fsi-footer-bg: rgba(255,255,255,0.96);
}
...
@media (prefers-color-scheme: dark) {
    :root {
        ...
        --fsi-muted: #cbd5e1;
        --fsi-primary: #93c5fd;
        --fsi-primary-soft: #60a5fa;
        --fsi-border: #475569;
        --fsi-input-bg: #0b1220;
        --fsi-input-text: #f8fafc;
        --fsi-shadow: rgba(0, 0, 0, 0.35);
        --fsi-footer-bg: rgba(17,24,39,0.96);
    }
}
...
.card, .sap-grid-card, .sap-section-card, .topbar, .top-strip, .total-box,
div[data-testid="stForm"], div[data-testid="stExpander"] details {
    background: var(--fsi-card) !important;
    color: var(--fsi-text) !important;
    border-color: var(--fsi-border) !important;
    box-shadow: 0 1px 8px var(--fsi-shadow) !important;
}

.topbar h1, .main-title-center, .fsi-app-title, .sap-grid-card-title,
.sap-subtitle, .input-section-title, h1, h2, h3, h4, h5, h6 {
    color: var(--fsi-primary) !important;
}

div[data-testid="stMarkdownContainer"], p, span, div, td, th {
    color: inherit;
}
...
.stTextArea textarea {
    ...
    color: var(--fsi-input-text) !important;
...
button[data-baseweb="tab"] {
    background: var(--fsi-card-2) !important;
    color: var(--fsi-primary) !important;
}
...
.fsi-login-slogan-footer {
    ...
    border-top: 1px solid var(--fsi-border) !important;
    background: var(--fsi-footer-bg) !important;
...
.fsi-slogan-footer span,
.fsi-login-slogan-footer span {
...
def render_slogan_footer(login=False):
    ...
    slogan = "Developed by Rajesh Dhokale | dhokaleraj@icloud.com | Copyrights to jrdhokale"
    st.markdown(
        '<div class="' + cls + '"><span>' + slogan + '</span></div>',
        unsafe_allow_html=True
    )
