...
def render_slogan_footer(login=False):
    ...
    st.markdown('<div class="' + cls + '"><span style="display:inline-block;text-align:center;width:100%;">Developed by Rajesh Dhokale&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Connect : dhokaleraj@icloud.com</span></div>', unsafe_allow_html=True)
